...
$|[{\mathcal I}_2^{RS}]-[{\mathcal I}_2^{1\textrm{-}RSB}]|/N\sim 2\cdot 10^{-5}$. Finally, clear deviations 
...
%##########################################################################
\subsection{R\'eny entropy and mutual information: Exact treatment}
...
The partition function of the model on a single sheet is given as 
%
\begin{equation}
Z(\beta)\equiv\textrm{Tr}\rho=\sum\limits_{p=0}^NB(N,p)e^{N\beta(\frac{p}{N}-
\frac{1}{2})^2},
\end{equation}
%
...
%
\begin{equation}
\rho_A\equiv\frac{1}{Z}\textrm{Tr}_B\sum\limits_{p,i}e^{N(\beta\frac{p}{N}-
...
%
\begin{equation}
R(p_A)\equiv\frac{1}{Z}\sum\limits_{p_B=0}^{N-N_A}B(N-N_A,p_B)e^{N\beta
