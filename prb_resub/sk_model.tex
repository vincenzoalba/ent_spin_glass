...
analytically. In the high-temperature region the permutation symmetry among both the replicas  
...
partition functions using Eq.~\eqref{renyi} and Eq.~\eqref{MI}. Notice that the disorder-averaged 
