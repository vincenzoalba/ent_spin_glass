...
booklet ratios $\omega=3/4,1/2,1/4$ (see Fig.~\ref{cartoon}). In all panels the 
...
\propto N$. This is in contrast with local models, where $[{\mathcal I}_n]$ by 
construction one finds an area law at all temperatures. Here we consider the 
